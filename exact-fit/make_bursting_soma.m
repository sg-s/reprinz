...
% add the channels
x.CellBody.add('prinz-approx/ACurrent','E',-80);
x.CellBody.add('prinz-approx/CaS','E',0);
x.CellBody.add('prinz-approx/CaT','E',0);
x.CellBody.add('liu-approx/HCurrent','E',-20);
x.CellBody.add('prinz-approx/KCa','E',-80);
x.CellBody.add('prinz-approx/Kd','E',-80);
